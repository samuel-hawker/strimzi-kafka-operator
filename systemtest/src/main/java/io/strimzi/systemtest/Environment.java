...
public class Environment {
    ...
    private static final String STRIMZI_ROLES_ONLY_DEFAULT = "false";
    /**
     * OLM env variables
     */
    ...
    public static final String STRIMZI_ROLES_ONLY = getOrDefault(STRIMZI_ROLES_ONLY_ENV, STRIMZI_ROLES_ONLY_DEFAULT);

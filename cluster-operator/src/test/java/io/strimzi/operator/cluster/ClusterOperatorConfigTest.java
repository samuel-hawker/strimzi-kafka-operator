...
public class ClusterOperatorConfigTest {
    ...
    public void testReconciliationInterval() {
        ...
        ClusterOperatorConfig config = new ClusterOperatorConfig(singleton("namespace"), 60_000, 30_000, false, new KafkaVersion.Lookup(emptyMap(), emptyMap(), emptyMap(), emptyMap(), emptyMap()), null, null, ClusterOperatorConfig.PermissionsMode.CLUSTER);
